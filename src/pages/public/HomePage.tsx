...
export const HomePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* 1. HERO SECTION WITH AMBIENT GLOW ORBS */}
      <section
      ...
      >
        ...
        <div className="ambient-glow-orb ambient-glow-gold" />
        <div className="ambient-glow-orb ambient-glow-cyan" />
      ...
      {/* 2. CINEMATIC SCROLL-DRIVEN EXPERIENCE (CHAOS → CLARITY) */}
      <CinematicScroll />
