  ...
  return (
    <div className="section-py-sm">
      <SEO
        ...
        canonical="https://example.com/calculators/profit"
      />
        ...
        <div className="calc-detail-layout">
          ...
          <div className="calc-inputs-panel">
            ...
            <div className="form-group">
              <label className="form-label">Total Client Revenue / Billing</label>
            ...
            <div className="form-group">
              <label className="form-label">Direct Deliverable Costs (Contractors, Asset licenses)</label>
              <div className="input-with-prefix">
                <span className="input-prefix">$</span>
                <input
                  type="number"
            ...
            <div className="form-group">
              <label className="form-label">Allocated Overhead Costs (Software, Equipment, Utilities)</label>
              <div className="input-with-prefix">
                <span className="input-prefix">$</span>
                <input
                  type="number"
            ...
            <div className="form-group">
              <label className="form-label">Estimated Income / Business Tax Rate (%)</label>
