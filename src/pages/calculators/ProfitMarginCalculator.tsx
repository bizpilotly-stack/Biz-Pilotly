  ...
  return (
    <div className="section-py-sm">
      <SEO
        ...
        canonical="https://example.com/calculators/profit-margin"
      />
      ...
      <div className="container">
        ...
        <div className="calc-detail-layout">
          <div className="calc-inputs-panel">
            ...
            <div className="form-group">
              <label className="form-label">Total Delivery / Labor Cost ($)</label>
              ...
              <p className="form-hint">Internal time, subcontractor costs, software expenses</p>
            </div>

            <div className="form-group">
              <label className="form-label">Desired Profit Margin Percentage (%)</label>
          ...
          <div className="calc-results-panel">
            <div className="calc-result-header">
              <div style={{ fontSize: '0.75rem', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 }}>
                Recommended Client Selling Price
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.5rem', fontSize: '0.875rem', color: '#38bdf8' }}>
                <Sparkles size={16} />
                <span>Yields <strong>{formatCurrency(res.profit)}</strong> in gross profit</span>
              </div>
            </div>
            ...
            <div className="calc-stats-grid">
              ...
              <div className="calc-stat-item">
                ...
                <div className="calc-stat-val" style={{ color: 'var(--brand-gold-400)' }}>{formatPercent(res.markupPercent)}</div>
              </div>

              <div className="calc-stat-item">
                <div className="calc-stat-label">Baseline Cost</div>
                <div className="calc-stat-val">{formatCurrency(res.cost)}</div>
              </div>

              <div className="calc-stat-item">
                <div className="calc-stat-label">Target Margin</div>
                <div className="calc-stat-val">{formatPercent(margin)}</div>
              </div>
            </div>
            ...
            <div style={{ marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <Link to="/documents/quote" className="btn btn-gold" style={{ width: '100%', justifyContent: 'center' }}>
                <FileText size={16} />
                <span>Create Quote for {formatCurrency(res.sellingPrice)}</span>
                <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        ...
        <div className="calc-cta-banner">
          <div className="calc-cta-text">
            ...
            <p>Send an official quote with itemized scopes and expiry terms.</p>
          </div>
