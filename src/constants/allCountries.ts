...
/**
 * Complete directory of all sovereign countries sorted strictly in alphabetical order (A-Z)
 */
export const ALL_WORLD_COUNTRIES: CountryInfo[] = [
  ...
  { code: 'GY', name: 'Guyana', flag: 'GYD', currency: 'GYD', currencySymbol: '$' },
  ...
  { code: 'UZ', name: 'Uzbekistan', flag: 'UZS', currency: 'UZS', currencySymbol: "so'm" },
